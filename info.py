...
API_ID = int(environ.get('API_ID', '7789657'))
API_HASH = environ.get('API_HASH', '124b302f0d2aebd8049cf953303612d5')
BOT_TOKEN = environ.get('BOT_TOKEN', "6913745886:AAH_DoirRSHUdf0c_lmhJl5YNEGs3YFU-I4")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))

PICS = (environ.get('PICS', 'https://telegra.ph/file/a33dff4d87b4ac02fb145.jpg')).split() #SAMPLE PIC
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6707861656').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001506157872').split()] #Channel id for auto indexing ( make sure bot is admin )
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1869876509').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '').split()]
auth_channel = environ.get('AUTH_CHANNEL', '-1002029678338') #Channel / Group Id for force sub ( make sure bot is admin )
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002029678338') # request channel id ( make sure bot is admin )
...
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : catwomenxTeam')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', ' -1002069672405')) #Log channel id ( make sure bot is admin )
...
OWNER_USERNAME = "VIRUSEPIC"


# add premium logs channel id
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002069672405'))
